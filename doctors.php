                ...
                <div class="card card-hover doctor-card" data-reveal data-tilt>
                    <div class="doctor-card-top">
                        ...
                        <div>
                            ...
                            <?php if ((int)$d['rating_count'] > 0): ?><div class="rating"><i class="ri-star-fill"></i> <?= number_format($d['rating_avg'], 1) ?> (<?= (int)$d['rating_count'] ?>)</div><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <?php if ((int)$d['experience_years'] > 0 || $d['clinic_city']): ?>
                    ...
                    <?php endif; ?>
                    <?php $hasFee = (float)$d['consultation_fee_online'] > 0; ?>
                    <div class="doctor-card-footer">
                        ...
                        <?php endif; ?>
                        <a href="<?= e(doctor_url($d['slug'])) ?>" class="btn btn-outline btn-sm"<?= (!$hasFee && !$d['free_consultation']) ? ' style="margin-left:auto;"' : '' ?>>View Profile</a>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
