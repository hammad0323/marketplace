...
CREATE TABLE blog_posts (
    ...
    content        LONGTEXT COMMENT 'legacy single rich-text body; superseded by `blocks` for posts written with the block editor',
    blocks         LONGTEXT DEFAULT NULL COMMENT 'JSON array of content blocks (heading/richtext/image/gallery/video/map/doctor/medicine/comparison_table/fact_box/callout/faq/toc/quote) — when set, takes over rendering from `content`',
