...
('smtp_encryption', 'tls'),
('smtp_from_email', ''),
('smtp_from_name', 'DoctorApna');

INSERT INTO cms_pages (slug, title, content, meta_title, meta_description) VALUES
('about', 'About DoctorApna', '<p>DoctorApna connects patients with verified, board-certified doctors for online and in-person consultations. Our mission is to make quality healthcare accessible, transparent, and fast — whether you need a five-minute follow-up or a same-day specialist referral.</p><p>Every doctor on our platform is manually verified by our medical credentialing team before they can accept patients.</p>', 'About Us | DoctorApna', 'Learn about DoctorApna''s mission to make verified healthcare accessible to everyone.'),
('privacy-policy', 'Privacy Policy', '<p>We collect only the information required to deliver our telemedicine services: your account details, appointment history, and any medical documents you choose to upload. Data is encrypted in transit and access is restricted to your care team and platform administrators.</p><p>We never sell patient data to third parties.</p>', 'Privacy Policy | DoctorApna', 'How DoctorApna collects, uses, and protects your personal and medical information.'),
('terms-conditions', 'Terms & Conditions', '<p>By using DoctorApna you agree to provide accurate information when booking appointments and to attend or cancel/reschedule with reasonable notice. DoctorApna is a booking and communication platform; all medical advice is provided solely by the independent, licensed practitioners on our platform.</p>', 'Terms & Conditions | DoctorApna', 'The terms governing use of the DoctorApna telemedicine platform.');
...
('Dr. Elena Petrova', 'Orthopedic Surgeon', 'DoctorApna''s scheduling tools cut my no-show rate in half. The platform is genuinely built for how clinicians work.', 5, 3);
...
(1, 'How Doctor Verification Works on DoctorApna', 'how-doctor-verification-works-on-mediconnect',
