...
$pending = pending_category_requests();
$all = all_category_requests();
    ...
    <?php else: ?>
        <table class="admin-table">
            ...
            <?php foreach ($pending as $request): ?>
                <tr>
                    <td><?= e($request['store_name']) ?></td>
                    <td><?= e($request['category_name']) ?></td>
                    <td><?= e($request['created_at']) ?></td>
                    <td>
                        <form method="post" action="/admin/category-requests/<?= (int) $request['id'] ?>/decide">
                            <?= csrf_field() ?>
        ...
        <?php foreach ($all as $request): ?>
            <tr>
                ...
                <td>
                    ...
                    <form method="post" action="/admin/category-requests/<?= (int) $request['id'] ?>/toggle" class="inline-form">
                        <?= csrf_field() ?>
