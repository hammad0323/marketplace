...
$productCount = count(products_by_vendor($vendor['id']));
$categoryRequests = $marketplaceSlug === 'business' ? vendor_category_requests_for_vendor($vendor['id']) : [];
...
<?php elseif ($vendor['status'] === 'rejected'): ?>
    <div class="content-panel" style="margin-top:1rem;">
        ...
        <p><?= e($vendor['rejection_reason'] ?: 'No reason was provided.') ?></p>
...
<div class="card-grid" style="margin-top:1.5rem;">
    <div class="content-panel">
        ...
        <a class="btn btn-secondary" href="/vendor/dashboard/profile">Edit Profile</a>
    </div>
    ...
    <div class="content-panel">
        ...
        <a class="btn btn-secondary" href="/vendor/dashboard/categories">Manage Categories</a>
    </div>
    <?php endif; ?>
    ...
    <div class="content-panel">
        ...
        <a class="btn btn-secondary" href="/vendor/dashboard/products">View Products</a>
