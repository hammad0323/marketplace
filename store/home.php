...
<section class="parallax-hero home-hero">
    ...
    <div class="home-hero-content reveal">
        ...
        <div style="display:flex; gap:1rem; justify-content:center; flex-wrap:wrap;">
            <a class="btn btn-accent" href="<?= mp_e(ROUTE_ARTISAN) ?>index.php">Explore Artisan Marketplace</a>
            <a class="btn btn-secondary" href="<?= mp_e(ROUTE_BUSINESS) ?>index.php">Explore Business Shops</a>
        </div>
    </div>
</section>
