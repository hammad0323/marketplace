...
<div>
    <?php foreach ($categories as $category): ?>
        <a class="artisan-category-chip" href="/artisan/category/<?= mp_e($category['slug']) ?>"><?= mp_e($category['name']) ?></a>
    <?php endforeach; ?>
</div>
    ...
    <?php foreach ($featuredArtisans as $vendor): ?>
        <div class="vendor-card">
            <div class="vendor-card-body">
                ...
                <div><a href="/artisan/<?= mp_e($vendor['slug']) ?>"><strong><?= mp_e($vendor['store_name']) ?></strong></a></div>
            </div>
        </div>
    <?php endforeach; ?>
