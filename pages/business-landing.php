...
<div>
    <?php foreach ($categories as $category): ?>
        <a class="business-category-chip" href="/business/category/<?= mp_e($category['slug']) ?>"><?= mp_e($category['name']) ?></a>
    <?php endforeach; ?>
</div>
    ...
    <?php foreach ($featuredShops as $vendor): ?>
        <div class="vendor-card">
            <div class="vendor-card-body">
                ...
                <div><a href="/business/<?= mp_e($vendor['slug']) ?>"><strong><?= mp_e($vendor['store_name']) ?></strong></a></div>
            </div>
        </div>
    <?php endforeach; ?>
