...
<section style="text-align:center; margin: 3rem 0;">
    ...
    <p><a href="/store/official-store"><?= mp_e($officialStore['store_name']) ?></a> — verified and curated directly by the platform.</p>
</section>
<?php endif; ?>
        ...
        <?php foreach ($featuredArtisans as $vendor): ?>
            <div class="vendor-card">
                <div class="vendor-card-body">
                    <strong><a href="/artisan/<?= mp_e($vendor['slug']) ?>"><?= mp_e($vendor['store_name']) ?></a></strong>
...
<section>
    ...
    <div class="card-grid">
        <?php foreach ($featuredBusinesses as $vendor): ?>
            <div class="vendor-card">
                <div class="vendor-card-body">
                    <strong><a href="/business/<?= mp_e($vendor['slug']) ?>"><?= mp_e($vendor['store_name']) ?></a></strong>
