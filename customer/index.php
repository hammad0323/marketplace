...
<div class="section-tight">
  <div class="container-xl">
    ...
    <div class="stat-grid" style="grid-template-columns:repeat(3,1fr);">
      <a href="<?php echo url('/customer/trips.php'); ?>" class="stat-card" style="display:block;"><div class="icon-wrap"><i class="bi bi-map"></i></div><div class="value"><?php echo (int) $tripCount; ?></div><div class="label">Saved trips</div></a>
      <a href="<?php echo url('/customer/bookings.php'); ?>" class="stat-card" style="display:block;"><div class="icon-wrap"><i class="bi bi-calendar-check"></i></div><div class="value"><?php echo (int) $bookingCount; ?></div><div class="label">Bookings</div></a>
    ...
    <div class="cta-band" style="margin-top:24px;padding:32px;">
      ...
      <a href="<?php echo url('/pages/trip-planner.php'); ?>" class="btn-w btn-white">Plan a trip <i class="bi bi-arrow-right"></i></a>
    </div>
  </div>
</div>
