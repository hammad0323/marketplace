...
$extraScripts = '<script defer src="' . asset_url('/assets/js/rich-editor.js') . '"></script><script defer src="' . asset_url('/assets/js/seo-score.js') . '"></script>'
    ...
    . '<script defer src="' . asset_url('/assets/js/medicine-form.js') . '"></script>';
