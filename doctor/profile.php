...
$heading = 'My Profile';
$extraScripts = '<script src="/assets/js/profile.js"></script><script src="/assets/js/certificate-upload.js"></script><script src="/assets/js/doctor-profile-extra.js"></script>';
