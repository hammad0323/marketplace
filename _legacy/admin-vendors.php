        ...
        <table class="admin-table">
            ...
            <?php foreach ($pending as $vendor): ?>
                <tr>
                    ...
                    <td>
                        <form method="post" action="/admin-vendor-approve.php?id=<?= (int) $vendor['id'] ?>" class="inline-form">
                            <?= mp_csrf_field() ?>
                            <button type="submit" class="btn">Approve</button>
                        </form>
                        <form method="post" action="/admin-vendor-reject.php?id=<?= (int) $vendor['id'] ?>" class="inline-form" onsubmit="return promptReject(this);">
                            <?= mp_csrf_field() ?>
