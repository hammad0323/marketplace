...
$heading = 'My Profile';
$extraScripts = '<script defer src="' . asset_url('/assets/js/profile.js') . '"></script><script>window.CERT_UPLOAD_URL="/ajax/pharmacy-certificate.php";</script><script defer src="' . asset_url('/assets/js/certificate-upload.js') . '"></script>';
...
<div class="split-sidebar-left">
    ...
    <div>
        <div class="tabs-row" role="tablist">
            <button class="tab-btn active" id="tab-btn-info" role="tab" aria-controls="panel-info" aria-selected="true" tabindex="0">Store Info</button>
