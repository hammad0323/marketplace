...
<header class="admin-header">
    <a href="/admin-dashboard.php" class="admin-brand">Marketplace Admin</a>
    <?php if (mp_current_admin()): ?>
    <nav class="admin-nav">
        <a href="/admin-vendors.php">Vendor Approvals</a>
        <a href="/admin-category-requests.php">Category Approvals</a>
