...
$specs = mysqli_query(db(), "
    SELECT s.*, (SELECT COUNT(*) FROM doctors d WHERE d.specialization_id = s.id AND d.verification_status='verified') AS doctor_count
...
<section class="section" style="padding-top:calc(var(--header-height) + 48px);">
    <div class="container">
        <nav class="breadcrumb"><a href="/index.php">Home</a> <i class="ri-arrow-right-s-line"></i> <span>Specializations</span></nav>
