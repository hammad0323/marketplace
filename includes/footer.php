  ...
  <div class="container-xl">
    <div class="footer-grid">
      <div class="footer-col">
        <a href="<?php echo url('/index.php'); ?>" class="brand"><span class="brand-mark"><i class="bi bi-compass"></i></span><?php echo e($siteName ?? APP_NAME); ?></a>
      ...
      <div class="footer-col">
        ...
        <?php foreach ($footerCities as $c): ?>
          <a href="<?php echo url('/pages/city.php'); ?>?slug=<?php echo e($c['slug']); ?>"><?php echo e($c['name']); ?></a>
        <?php endforeach; ?>
      </div>
      <div class="footer-col">
        <h6>Categories</h6>
        <?php foreach ($footerCategories as $cat): ?>
          <a href="<?php echo url('/pages/category.php'); ?>?slug=<?php echo e($cat['slug']); ?>"><?php echo e($cat['name']); ?></a>
        <?php endforeach; ?>
      </div>
      <div class="footer-col">
        <h6>Company</h6>
        <a href="<?php echo url('/pages/page.php'); ?>?slug=about">About Us</a>
        <a href="<?php echo url('/pages/blog.php'); ?>">Blog</a>
        <a href="<?php echo url('/pages/page.php'); ?>?slug=terms">Terms of Service</a>
        <a href="<?php echo url('/pages/page.php'); ?>?slug=privacy">Privacy Policy</a>
        <a href="<?php echo url('/pages/page.php'); ?>?slug=faq">FAQ</a>
      </div>
      <div class="footer-col">
        <h6>Stay in the loop</h6>
        <p>Get trip ideas and deals in your inbox.</p>
        <form class="newsletter-box" method="post" action="<?php echo url('/ajax/newsletter.php'); ?>">
          <?php echo csrf_field(); ?>
