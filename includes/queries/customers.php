...
function insert_customer(array $data): int
{
    $stmt = db()->prepare(
...
function customer_follow_vendor(int $customerId, int $vendorId): void
{
    $stmt = db()->prepare(
...
function customer_unfollow_vendor(int $customerId, int $vendorId): void
{
    $stmt = db()->prepare(
...
function customer_rate_vendor(int $customerId, int $vendorId, int $rating, ?string $review): void
{
    $stmt = db()->prepare(
